...
router.route('/')
    ...
    .post((req, res) => {
        ...
        req.checkBody('imgUrl', 'Campo da Imagem é obrigatorio').notEmpty();
        ...
        if (errors) { // Caso haver ERRO, renderiza o formulário novamente com os erros (find categorias para o select)
            ...
            let newItem = new db.Item({ name: req.body.name, category: req.body.category, imgUrl: req.body.imgUrl });
